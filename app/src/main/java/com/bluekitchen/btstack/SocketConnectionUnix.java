...
public class SocketConnectionUnix extends SocketConnection {
  ...
  private static final String UNIX_SOCKET_NAME = "/data/btstack/BTstack";
  ...
  public boolean connect() {
    try {
      ...
      LocalSocketAddress socketAddress = new LocalSocketAddress(UNIX_SOCKET_NAME, LocalSocketAddress.Namespace.FILESYSTEM);
